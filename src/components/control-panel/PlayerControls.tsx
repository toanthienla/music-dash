...
const PlayerControls: React.FC<PlayerControlsProps> = ({
  ...
  // Handle volume change (update UI only)
  const handleVolumeSliderChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const newVolume = Number(e.target.value);
    onVolumeChange(newVolume);
  };

  // Handle volume change end (call API)
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-4 gap-2 mt-6 mb-4 items-center justify-items-center">
        ...
        {/* --- Volume Button with Simple Panel --- */}
        <div className="relative" ref={volumeButtonRef}>
          ...
          {showVolumePanel && (
            <div className="absolute left-1/2 -translate-x-1/2 bg-white border border-gray-200 rounded-lg shadow-lg p-3 z-50 w-40">
              {/* Horizontal Slider */}
              <input
                ref={volumeSliderRef}
                type="range"
